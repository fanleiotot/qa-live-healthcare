-- SQL script to import doctor users from doctor-user-list.json

-- Insert into doctor_user table
INSERT INTO doctor_user (id, username, password, name, title, department, avatar, experience, is_active)
VALUES
...
-- Insert into doctor_specialties table
